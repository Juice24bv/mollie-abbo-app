...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('ℹ️ Metadata:', payment.metadata);
    console.log('ℹ️ Sequence type:', payment.sequenceType);
    console.log('ℹ️ Betaald:', payment.status);
